      ...
      <div className="w-64 bg-white/80 backdrop-blur-xl border-r border-structure/20 flex flex-col h-full shrink-0">
        ...
        <div className="p-4 border-t border-structure/20 m-4 rounded-xl bg-structure/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-bold text-ink truncate w-24">{user?.username}</div>
                  ...
                  <div className="flex flex-col md:flex-row items-start justify-between gap-6">
                    <div>
                      ...
                      <h1 className="font-serif text-5xl font-bold mb-4 tracking-tight">
                        Welcome, {profile?.full_name || user?.username || 'Recruiter'}
                      </h1>
                ...
                {isEditingProfile ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-4 items-center">
                      ...
                      <div>
                        <div className="font-serif font-bold text-xl text-ink">{profile?.full_name || user?.username}</div>
...
with open("scratch_recruiter.py", "w") as f:
    pass

with open("scratch_recruiter.tsx", "w") as f:
    f.write(content)
